...
FROM GIAOVIEN GV , BOMON BM, THAMGIADT DT
WHERE GV.MABM =BM.MABM AND DT.MAGV=GV.MAGV AND BM.TENBM=N'Vi sinh' AND DT.MADT='006'

--Q11 
SELECT  GV2.HOTEN N'GIÁO VIÊN', GV1.HOTEN N'GIÁO VIÊN QUẢN LÍ CHUYÊN MÔN'
...
SELECT GV1.HOTEN
FROM GIAOVIEN GV1, GIAOVIEN GV2
WHERE GV1.MAGV=GV2.GVQLCM AND GV2.GVQLCM=N'Nguyễn Thanh Tùng'
...
WHERE GV.MABM=BM.MABM AND GV.MABM='HTTT'AND GV.GVQLCM IS NOT NULL
...
FROM GIAOVIEN GV ,BOMON BM
WHERE GV.MABM=BM.MABM AND BM.MABM='HTTT' AND GV.GVQLCM IS NOT NULL
